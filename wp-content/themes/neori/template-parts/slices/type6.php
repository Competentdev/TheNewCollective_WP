<div class="slice type6">
  ...
  <?php if(get_theme_mod('neori_slice_type6_category_description_setting')) : ?>

    <h4 class="slice-description"><?php echo esc_html( get_theme_mod ('neori_slice_type6_category_description_setting', '')); ?></h4>
  ...
  <div class="card-deck">
    ...
    <?php
      ...
      $args = array(
        ...
        'offset' => esc_html ( get_theme_mod ('neori_slice_type6_offset_posts_setting', '')),
      );
