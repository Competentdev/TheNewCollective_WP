<div class="slice type3">
	...
	<?php if(get_theme_mod('neori_slice_type3_category_description_setting')) : ?>

	<h4 class="slice-description"><?php echo esc_html( get_theme_mod ('neori_slice_type3_category_description_setting', '')); ?></h4>
	...
	<a href="./category/<?php echo esc_html( get_theme_mod ('neori_slice_type3_category_slug_setting', '')); ?>/"><h2 class="slice-view-more">View More</h2></a>
