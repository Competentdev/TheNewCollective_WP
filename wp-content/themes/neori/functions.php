...
function neori_scripts() {
  ...
  wp_enqueue_style( 'neori-style', get_stylesheet_uri(), array(), '3.0.0', 'all' );

  wp_enqueue_style( 'bootstrap-css', get_template_directory_uri() . '/css/bootstrap.min.css', array(), '4.0', 'all' );

  wp_enqueue_style( 'neori-modified-bootstrap-css', get_template_directory_uri() . '/css/modified-bootstrap.css', array(), '3.0.0', 'all' );
...
/* ------------------------------------------------------------
Enqueuing Gutenberg Editor CSS style
------------------------------------------------------------- */
function neori_gutenberg_editor_style() {

  wp_enqueue_style( 'gutenberg-editor-style', get_template_directory_uri() . '/css/gutenberg-editor-style.css' );
  wp_enqueue_style( 'neori-fonts', neori_google_fonts(), array(), '1.0.0' );

}

add_action( 'enqueue_block_editor_assets', 'neori_gutenberg_editor_style' );
...
Pagination
------------------------------------------------------------- */
function neori_classic_pagination() {
